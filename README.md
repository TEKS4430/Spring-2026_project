...
* include all three architectural components:

  * sensing and perception
  * reasoning, planning and decision-making
  * act and control

The implementation does not need to be a complete production-level system, but it should clearly demonstrate the core functionality of the system.
...
* clearly report who contributed what
* keep records of the division of work from the beginning of the project
* document group meetings and key decisions

This documentation must be included in the project submission.

**Note:** The documentation of the division of work and the transparency of the group’s working process will also affect the grade.
...
* explain the key technical solutions of the project
* reflect on what was learned during the project
* report how AI tools were used

The video presentation should be supported by **presentation slides**, which should describe:
